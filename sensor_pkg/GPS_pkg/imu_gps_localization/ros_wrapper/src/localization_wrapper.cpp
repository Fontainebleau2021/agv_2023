...
LocalizationWrapper::LocalizationWrapper(ros::NodeHandle& nh) {
    ...
    odom_pub_ = nh.advertise<nav_msgs::Odometry>("fused_odom", 10);
}
...
void LocalizationWrapper::ConvertStateToRosTopic(const ImuGpsLocalization::State& state) {
    ...
    ros_odom_.header.frame_id = "world";
    ros_odom_.header.stamp = ros::Time::now();  
    ...
    ros_odom_.pose.pose.position.x = pose.pose.position.x;
    ros_odom_.pose.pose.position.y = pose.pose.position.y;
    ros_odom_.pose.pose.position.z = pose.pose.position.z;

    ros_odom_.pose.pose.orientation.x = pose.pose.orientation.x;
    ros_odom_.pose.pose.orientation.y = pose.pose.orientation.y;
    ros_odom_.pose.pose.orientation.z = pose.pose.orientation.z;
    ros_odom_.pose.pose.orientation.w = pose.pose.orientation.w;
