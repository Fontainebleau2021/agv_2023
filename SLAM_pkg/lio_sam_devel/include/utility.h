...
enum class SensorType { VELODYNE, OUSTER, LIVOX, LS};
...
public:
    ...
    ParamServer()
    {
        ...
        else if (sensorStr == "livox")
        {
         ...
         else if (sensorStr == "ls")
        {
            sensor = SensorType::LS;
        }
        else
        {
            ROS_ERROR_STREAM(
                "Invalid sensor type (must be either 'velodyne' or 'ouster' or 'livox' or 'ls'): " << sensorStr);
            ros::shutdown();
        }
