...
public:
    ...
    void odomToMapPoseHandler(const geometry_msgs::PoseStamped::ConstPtr& poseOdomToMapmsg)
    {
        ...
        std::cout<<poseOdomToMapmsg->pose.position.x<<"  "<< poseOdomToMapmsg->pose.position.y<<" "<<poseOdomToMapmsg->pose.position.z<<std::endl;
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imu_raw)
    {
        ...
        odometry.pose.pose.position.z = 0; //lidarPose.translation().z();
        ...
        tf::StampedTransform odom_2_baselink = tf::StampedTransform(tCur, thisImu.header.stamp,  odometryFrame, baselinkFrame);
