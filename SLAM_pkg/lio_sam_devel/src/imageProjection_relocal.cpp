...
public:
    ...
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            thisPoint = deskewPoint(&thisPoint, 0.00005); // Velodyne
    ...
    void publishClouds()
    {
        ...
        cloudInfo.cloud_deskewed  = publishCloud(pubExtractedCloud, extractedCloud, cloudHeader.stamp, baselinkFrame);
